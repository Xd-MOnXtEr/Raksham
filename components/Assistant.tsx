...
const Assistant: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Namaste. I am your Sutradhara. To find the sacred bead that aligns with your celestial energy, may I ask for your Zodiac sign?', timestamp: Date.now() }
  ]);
